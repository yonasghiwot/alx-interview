...
Usage: nqueens N:
    o If the user called the program with the wrong number of arguments, print
        Usage: nqueens N, followed by a new line, and exit with the status 1.
where N must be an integer greater or equal to 4
    o If N is not an integer, print N must be a number, followed by a new line,
    and exit with the status 1.
    o If N is smaller than 4, print N must be at least 4, followed by a new
...
# A List to store all solutions to the N-Queens problem
solutions = []
